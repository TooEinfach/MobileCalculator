...
#define DATE "built on: Sat Aug 29 16:05:55 2020 UTC"
...
static const char compiler_flags[] = {
    ...
    'a','b','i',' ','-','I','/','h','o','m','e','/','n','i','c','k',
    '/','D','o','c','u','m','e','n','t','s','/','g','i','t','F','i',
    'l','e','s','/','M','o','b','i','l','e','C','a','l','c','u','l',
    'a','t','o','r','/','.','b','u','i','l','d','o','z','e','r','/',
    'a','n','d','r','o','i','d','/','p','l','a','t','f','o','r','m',
    '/','b','u','i','l','d','-','a','r','m','e','a','b','i','-','v',
    '7','a','/','b','u','i','l','d','/','p','y','t','h','o','n','-',
    'i','n','s','t','a','l','l','s','/','k','i','v','y','c','a','l',
    'c','/','i','n','c','l','u','d','e','/','p','y','t','h','o','n',
    '3','.','8','\0'
};
